...
\usepackage{graphicx,hyperref,su,url}
...
\title[SU style for Beamer]{
  Sogang University Style for Beamer \LaTeX}
...
\author[Taehoon Kim]{
  ...
  %\and Jihoon Yang
  \\\medskip
  {\small \url{taehoonkim@sogang.ac.kr} 
  %\and \url{yanjh@sogang.ac.kr}
  } \\ 
  %{\small \url{http://mllab.sogang.ac.kr}}
  }
...
\institute[Sogang University]{
  Data Mining Reaearch Laboratory \\
